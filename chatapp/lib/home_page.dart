// ignore_for_file: use_key_in_widget_constructors, annotate_overrides, prefer_final_fields, unnecessary_new, avoid_print, prefer_const_constructors, deprecated_member_use, prefer_collection_literals

import 'package:chatapp/all_user_screen.dart';
import 'package:chatapp/user_details.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  UserDetails _userDetails = UserDetails as UserDetails;
  ...
  Future<FirebaseUser> signIn() async {
    ...
    FirebaseUser user =
        (await _firebaseAuth.signInWithCredential(authCredential)) as FirebaseUser;
    return user;
  }
